...
function AdminOrdenesNuevas({ordenes}) {
    return (
        <div className="contenedor_contenido" >
            ...
            <h3 className="titulo_contenido">Orden Nuevas admin</h3>
            {
                    ordenes.length>0?(
                        <MostradorOrdenesAdmin ordenPendiente={true} ordenNueva={true} ordenes={ordenes}/>
                    ):(
...
export default AdminOrdenesNuevas
